...
export const crmTenantBranding = pgTable("crm_tenant_branding", {
  ...
  portalBgUrl: text("portal_bg_url"),
  ...
  btnColor: varchar("btn_color", { length: 50 }).default("#0ea5e9").notNull(),
  sidebarColor: varchar("sidebar_color", { length: 50 }).default("#0f172a").notNull(),
  loginColor: varchar("login_color", { length: 50 }).default("#0f172a").notNull(),
  portalColor: varchar("portal_color", { length: 50 }).default("#0f172a").notNull(),
